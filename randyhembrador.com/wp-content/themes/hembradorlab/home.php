...
<div id="home-content">
	...
	<div id="port-static" class="port-section">
	  ...
	  <div class="left-content">
	  	<h1>Static Works</h1>
	  	Work that does not change no matter how many times it is clicked. Despite the inherent laziness on behalf of the piece itself, its production generally involved some degree of effort.
	  </div>
	  <div class="right-content">
		<ul id="sta-icons">
		<?php
